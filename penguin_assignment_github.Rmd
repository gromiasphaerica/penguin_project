...
```
p value = <2e-16, which is significantly lower than 0.05; therefore, there is a singificant positive relationship between body mass and culmen length in these penguin species
